...
. generar_tablas.sh npuzzle_Results/npuzzle4x4_history0_depth20.txt npuzzle_Results/npuzzle4x4_history1_depth20.txt npuzzle_Results/npuzzle4x4_history0_depth20.txt | head -n -1 > npuzzle_Results/npuzzle4x4_depth20_TABLA.txt
