...
. generar_tablas.sh npuzzle_Results/npuzzle4x3_history0_depth20.txt npuzzle_Results/npuzzle4x3_history1_depth20.txt npuzzle_Results/npuzzle4x3_history2_depth20.txt | head -n -1 > npuzzle_Results/npuzzle4x3_depth20_TABLA.txt

. generar_tablas.sh topSpinCompactPuzzle_Results/topSpinCompactPuzzle16_4_history0_depth7.txt topSpinCompactPuzzle_Results/topSpinCompactPuzzle16_4_history1_depth7.txt topSpinCompactPuzzle_Results/topSpinCompactPuzzle16_4_history2_depth7.txt | head -n -1 > topSpinCompactPuzzle_Results/topSpinCompactPuzzle16_4_depth7_TABLA.txt
...
. generar_tablas.sh pancakePuzzle_Results/pancake16_history0_depth6.txt pancakePuzzle_Results/pancake16_history1_depth6.txt pancakePuzzle_Results/pancake16_history2_depth6.txt | head -n -1 > pancakePuzzle_Results/pancake16_depth6_TABLA.txt
